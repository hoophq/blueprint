...
func TestRoleARN(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			roleName:  "blueprint-readonly",
			want:      "arn:aws:iam::000000000000:role/blueprint-readonly",
		},
		{
			name:      "role with path-like name",
			partition: "aws",
			accountID: "999999999999",
			roleName:  "audit/blueprint",
			want:      "arn:aws:iam::999999999999:role/audit/blueprint",
		},
		{
